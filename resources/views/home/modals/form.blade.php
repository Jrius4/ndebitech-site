    ...
    <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }} col-md-8 col-lg-8">
    ...
    <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }} col-md-8 col-lg-8">
    ...
    <div class="form-group {{ $errors->has('company') ? 'has-error' : '' }} col-md-8 col-lg-8">
        ...
        <div class="form-group {{ $errors->has('telephone') ? 'has-error' : '' }} col-md-8 col-lg-8">
        ...
        <div class="form-group {{ $errors->has('idea') ? 'has-error' : '' }} col-md-8 col-lg-8">
        ...
        <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }} col-md-8 col-lg-8">
        ...
        <div class="form-group {{ $errors->has('budget') ? 'has-error' : '' }} col-md-8 col-lg-8">
            <label for="budget">BUDGET</label>
            <input class="form-control" type="text" name="budget" id="budget" placeholder="BUDGET">
        ...
        <div class="form-group {{ $errors->has('time_done') ? 'has-error' : '' }} col-md-8 col-lg-8">
        ...
        <div class="form-group {{ $errors->has('field_industry_id') ? 'has-error' : '' }} col-md-8 col-lg-8">
