                    ...
                    <div class="dropdown-menu megamenu">
                      <div class="row">
                        <div class="col-lg-4 d-none d-lg-block">
                          <div style="background: center center url('https://d19m59y37dris4.cloudfront.net/photo/1-4-1/img/hero-bg-1.jpg') no-repeat;" class="w-100 h-100"></div>
                        </div>
                        <div class="col-lg-8">
                          <div class="row px-lg-3 py-lg-5">
                            <div class="col-lg-4">
                                  ...
                                  <ul class="megamenu-list list-unstyled">
                                    <li class="megamenu-list-item"><a href="index-2.html" class="megamenu-list-link">Homepage 1   </a></li>
